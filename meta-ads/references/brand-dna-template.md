...
<!-- Updated: 2026-03-12 -->
<!-- Used by: meta-dna (extraction), meta-create (consumption), meta-generate (style injection) -->
...
### Screenshots (optional, populated by `/meta-ads dna`)
...
- Set by `meta-dna` Step 2b. Omitted entirely if screenshot capture failed or `--quick` was used.
...
4. **Existing ads** (if accessible via the Meta Ad Library): Override
