...
[Reads ~/.claude/skills/meta-ads/references/meta-creative-specs.md for placement safe zones]
...
5. **Read platform creative spec reference** for each platform in the brief:
   - `~/.claude/skills/meta-ads/references/meta-creative-specs.md` (Feed, Reels, Stories, Threads, Messenger, Audience Network safe zones)
