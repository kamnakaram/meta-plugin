"""Pytest configuration for the meta-ads eval harness.
...
def skill_descriptions() -> dict[str, str]:
    """Returns {skill_name: description_text} for every SKILL.md under meta-ads/ and skills/."""
    skill_files = [REPO_ROOT / "meta-ads" / "SKILL.md"] + sorted(
