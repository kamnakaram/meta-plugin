---
name: meta-analyze
description: "Meta Ads deep analysis covering Facebook, Instagram, and Threads advertising in the Andromeda + GEM + Lattice era. Evaluates 130+ checks across Pixel/CAPI health, creative diversity and Entity-ID clustering risk, account structure, ASC/AAC defaults for Sales/Leads/App, and audience targeting. Includes Advantage+ assessment and creative-as-targeting scoring. Use when user says Meta Ads, Facebook Ads, Instagram Ads, Threads ads, Advantage+, ASC, AAC, Andromeda, GEM, Lattice, Entity-ID clustering, creative diversity, Sales optimization, Leads optimization, App optimization, or Meta campaign."
user-invokable: true
...
2. Read `meta-ads/references/meta-audit.md` for full 50-check audit
3. Read `meta-ads/references/benchmarks.md` for Meta-specific benchmarks
4. Read `meta-ads/references/scoring-system.md` for weighted scoring
