...
Load `~/.claude/skills/meta-ads/references/image-providers.md` to confirm:
...
- `~/.claude/skills/meta-ads/references/meta-creative-specs.md`
...
- `~/.claude/skills/meta-ads/references/image-providers.md`: provider config, pricing, limits
- `~/.claude/skills/meta-ads/references/[platform]-creative-specs.md`: per-platform specs
- `~/.claude/skills/meta-ads/references/brand-dna-template.md`: brand injection schema
