---
name: meta-math
description: "Meta PPC financial calculator and modeling tool. CPA, ROAS, CPL calculations, break-even analysis, reach/frequency saturation and budget-headroom sizing, budget forecasting, LTV:CAC ratio analysis, and MER (Marketing Efficiency Ratio) assessment. Requires zero API access. Works with pasted data from Meta Ads Manager exports. Use when user says PPC math, ad calculator, break-even, budget forecast, ROAS calculator, CPA calculator, CPM, frequency, LTV CAC, or MER."
user-invokable: true
...
### 4. Reach / Frequency Saturation & Budget Headroom

```
Meta has no "impression share"; the equivalent question is whether an audience
is saturating (frequency climbing, CPM rising, CTR flat) and how much budget
headroom remains before efficiency degrades.

Frequency = Impressions / Reach
Audience Saturation flag = frequency above the objective's threshold
   (prospecting >5.0 / 7d, retargeting >12.0 / 7d)

Headroom sizing (before scaling into saturation):
Estimated extra results = current_daily_results x (target_freq / current_freq - 1)
   capped by audience size and the 20% scaling rule

Inputs needed:
- Reach and impressions (period)  -> frequency
- Current daily results and CPA
- Audience size (est. from Ads Manager)
- Current daily budget

Output:
- Current frequency and saturation status (healthy / warming / saturated)
- Budget headroom before frequency crosses threshold
- Priority: scale this audience, broaden targeting, or refresh creative
```
...
- **Meta Conversion Lift / Incremental Attribution** (holdout testing): AI-powered holdout measurement of real causal impact. Evaluate when Meta budget exceeds ~$5K/month.
...
- Objective and campaign type (Sales / Leads / App / Traffic / Awareness)
